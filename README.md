...
| 学习公社（ENAEA） | 无账号测试，功能未知可用性 | 开发中 🚧 |
| 大学生网络党校（ENAEA） | 无账号测试，功能未知可用性 | 开发中 🚧 |
| 中小学网络党校（ENAEA） | 无账号测试，功能未知可用性 | 开发中 🚧 |
| 码上研训 | 无账号测试，功能未知可用性  | 开发中 🚧 |
| 随行课堂 | 无账号测试，功能未知可用性 | 开发中 🚧 |
| 青书学堂 | 无账号测试，功能未知可用性 | 开发中 🚧 |
...
> 代码已开源，程序只供技术学习使用，严禁任何商业、盈利，严禁贩卖，严禁滥用，若对贵公司造成损失立马删库（保命(doge)）。
> 
